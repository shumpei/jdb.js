(function() {
  ...
  ObjectStore = (function() {
    ...
    function ObjectStore(options) {
      this.name = options.name, this.database = options.database, this.key = options.key, this.indexes = options.indexes, this.since = options.since;
